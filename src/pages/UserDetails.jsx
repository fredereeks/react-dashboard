        ...
        <div className="flex flex-col gap-2 md:flex-row justify-between items-center">
          <div className="flex gap-3 items-center">
            <div className="h-9 w-9 rounded-md overflow-hidden relative bg-cyan-400 dark:bg-slate-600/50">
              <img src={flight_beach} alt={`Umar Peruzzi`} className="absolute left-0 top-0 object-cover w-full h-full" />
            </div>
            <div className="flex flex-col flex-1 text-slate-700">
              <h3 className="text-sm font-medium leading-tight flex items-center gap-2"><span>Umar Peruzzi</span> <span className="text-[.5rem] bg-slate-200 dark:bg-slate-100 text-slate-400 dark:text-slate-700 font-semibold uppercase rounded-md text-center py-[.15rem] px-2 w-max">User</span></h3>
              <p className="text-xs opacity-90 font-light">This is the overview of Umar Peruzzi' Account</p>
            </div>
          </div>
                    ...
                    <div className="pr-1 flex gap-1 items-center">
                      ...
                      <div className="flex flex-col flex-1">
                        ...
                        <div className="flex gap-2 items-center font-thin">
                          <p className="text-[.85rem] font-light leading-tight">Umar Peruzzi</p> |
                          <p className="text-xs opacity-50 font-normal flex items-center"><IoChatboxEllipsesOutline className='text-inherit mr-[.05rem] text-[.56rem] mt-[.15rem]' /> &nbsp;12 Comments</p>
                        </div>
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="pr-1 py-2 text-slate-700 tooltip group">
                    ...
                    <div className="pr-1 flex gap-1 items-center">
                      ...
                      <div className="flex flex-col flex-1 max-w-[10rem]">
                        ...
                        <div className="flex gap-2 items-center font-thin">
                          <p className="text-[.85rem] font-light leading-tight">Umar Peruzzi</p> |
                          <p className="text-xs opacity-50 font-normal flex items-center"><IoChatboxEllipsesOutline className='text-inherit mr-[.05rem] text-[.56rem] mt-[.15rem]' /> &nbsp;9 Comments</p>
                        </div>
                      </div>
                    </div>
                  </td>
